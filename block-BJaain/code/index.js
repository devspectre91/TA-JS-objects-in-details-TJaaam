...
myObject.someMethod(); //Reference to myObject
...
person.displayName.call(person2); // Name: John Reed
...
console.log(getSecondData()); // 2, because obj2's function got binded to obj1, and value value of obj2's data is  [1,2,3], and 
// we accessed data[1]
